 ...
 */
#ifdef FS_TOWER_EYE
const uint8_t LED_BYTEMAP = 117;  // Number of bytes using the row / column scheme (17 don't care bytes)
PROGMEM prog_uint8_t rcLEDMap[] = {
    ...
    0xff, 0x64, 0x63, 0x62, 0x61, 0x60, 0x5f, 0xff, 0xff
};
#elif defined(FS_DRESS)
const uint8_t LED_BYTEMAP = 64;  // Number of bytes using the bitmap scheme
PROGMEM prog_uint8_t rcLEDMap[] = {
  0xff, 0x2b, 0x2a, 0x29, 0x28, 0xff, 0xff, 0xff, //1
  0xff, 0x24, 0x25, 0x26, 0x27, 0xff, 0xff, 0xff, //2
  0xff, 0x23, 0x22, 0x21, 0x20, 0x1f, 0xff, 0xff, //3
  0xff, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0xff, 0xff, //4
  0xff, 0x19, 0x18, 0x17, 0x16, 0x15, 0xff, 0xff, //5
  0xff, 0x0f, 0x10, 0x11, 0x12, 0x13, 0x14, 0xff, //6
  0x0e, 0x0d, 0x0c, 0x0b, 0x0a, 0x09, 0x08, 0xff, //7
  0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07  //8
};
#else
const uint8_t LED_BYTEMAP = 54;  // Number of bytes using the row / column scheme (4 don't care bytes)
PROGMEM prog_uint8_t rcLEDMap[] = {
...
#elif defined(FS_DRESS)
const uint8_t LED_BMMAP = 64;  // Number of bytes using the bitmap scheme
PROGMEM prog_uint8_t bmLEDMap[] = {
  0xff, 0x2b, 0x2a, 0x29, 0x28, 0xff, 0xff, 0xff, //1
  0xff, 0x24, 0x25, 0x26, 0x27, 0xff, 0xff, 0xff, //2
  0xff, 0x23, 0x22, 0x21, 0x20, 0x1f, 0xff, 0xff, //3
...
#elif defined(FS_DRESS)
PROGMEM prog_uint8_t cylonVertical1[] = {0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
PROGMEM prog_uint8_t cylonVertical2[] = {0x00, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
PROGMEM prog_uint8_t cylonVertical3[] = {0x00, 0x00, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00};
PROGMEM prog_uint8_t cylonVertical4[] = {0x00, 0x00, 0x00, 0xFF, 0x00, 0x00, 0x00, 0x00};
PROGMEM prog_uint8_t cylonVertical5[] = {0x00, 0x00, 0x00, 0x00, 0xFF, 0x00, 0x00, 0x00};
PROGMEM prog_uint8_t cylonVertical6[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x00, 0x00};
PROGMEM prog_uint8_t cylonVertical7[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x00};
PROGMEM prog_uint8_t cylonVertical8[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF};
const int cylonVerticalFrameCount = 14;
PROGMEM prog_uint8_t *cylonVerticalTable[] =
{
    cylonVertical1,
    cylonVertical2,
...
PROGMEM prog_uint8_t cylonVertical5[] = {0xA5, 0xA5, // Front right panel
    ...
    0xAA, 0xAA}; // Front left panel#endif
const int cylonVerticalFrameCount = 8;
PROGMEM prog_uint8_t *cylonVerticalTable[] =
{
    cylonVertical1,
...
#elif defined(FS_DRESS)
PROGMEM prog_uint8_t cylonPong1[] = {0x10, 0x10, 0x20, 0x20, 0x20, 0x40, 0x40, 0x80};
PROGMEM prog_uint8_t cylonPong2[] = {0x10, 0x10, 0x10, 0x10, 0x10, 0x20, 0x20, 0x40};
PROGMEM prog_uint8_t cylonPong3[] = {0x08, 0x08, 0x08, 0x08, 0x08, 0x10, 0x10, 0x20};
PROGMEM prog_uint8_t cylonPong4[] = {0x04, 0x04, 0x04, 0x04, 0x04, 0x08, 0x04, 0x04};
PROGMEM prog_uint8_t cylonPong5[] = {0x02, 0x02, 0x02, 0x02, 0x02, 0x04, 0x02, 0x02};
PROGMEM prog_uint8_t cylonPong6[] = {0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x01, 0x01};
const int cylonPongFrameCount = 10;
PROGMEM prog_uint8_t *cylonPongTable[] =
{
    cylonPong1,
    cylonPong2,
...
#elif defined(FS_DRESS)
const int matrixFrameCount = 9;
PROGMEM prog_uint8_t matrixBitmap[]  = {
    0x0f, 0xff, 0x00, 0x1f, 0x00, 0x2f, 0x0f, 0x0f, // Row 0
    0x1f, 0x00, 0x00, 0x2f, 0x0f, 0xff, 0x1f, 0x1f, // Row 1
    0x2f, 0x0f, 0x0f, 0xff, 0x1f, 0x00, 0x2f, 0x2f, // Row 2
    0xff, 0x1f, 0x1f, 0x00, 0x2f, 0x0f, 0xff, 0xff, // Row 3
    0x00, 0x2f, 0x2f, 0x00, 0xff, 0x0f, 0x00, 0x00, // Row 4
    0x0f, 0xff, 0xff, 0x0f, 0x00, 0x1f, 0x0f, 0x0f, // Row 5
    0x1f, 0x0f, 0x00, 0x1f, 0x00, 0x2f, 0x1f, 0x1f, // Row 6
    0x2f, 0x1f, 0x00, 0x2f, 0x00, 0xff, 0x2f, 0x2f, // Row 7
    0xff, 0x2f, 0x00, 0xff, 0x00, 0x00, 0xff, 0xff}; // Row 8
#else
